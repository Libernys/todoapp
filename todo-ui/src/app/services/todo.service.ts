...
export class TodoService {
  ...
  deleteByTitle(title: any): Observable<any> {
    return this.http.delete(`${baseUrl}/by?title=${title}`);
  }

  deleteCompleted(title: any): Observable<any> {
    return this.http.delete(`${baseUrl}/completed?title=${title}`);
  }
}
